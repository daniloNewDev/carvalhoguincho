const Banner = () => {
  return (
    <div className="w-[100vw] h-[350px] bg-white-car bg-right-top" >
      ...
      <div className='w-full absolute top-0 h-[671px] flex items-center justify-center flex-col'>
        ...
        />
        <div className="w-full absolute top-48 flex flex-col items-center bg-gradient-to-t from-[#1d1c1c85] from-60% via-[#25252569] via-80% to-[#3d0a0a18] to-96%">
