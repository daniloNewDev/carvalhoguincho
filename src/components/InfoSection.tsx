const InfoSection = () => {
  return (
    <div className="bg-white pt-8 w-full flex flex-col lg:flex-row items-center justify-around">
      ...
      <div className="w-full flex flex-col items-center justify-center bg-callcenter">
        <div className="w-80 h-96 lg:w-60 lg:h-60 px-8 my-8 bg-red-600 rounded-xl mb-8 pt-5 shadow-md shadow-black2 flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center justify-center bg-highway">
        <div className="w-80 h-96 lg:w-60 lg:h-60 px-8 my-8 bg-white rounded-xl mb-8 pt-5 shadow-md shadow-black2 flex flex-col items-center">
          <a href="tel:+5511953540184" target="_blank" rel="noopener noreferrer">
